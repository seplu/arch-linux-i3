...
```
aur_packages: ['buku-git','google-chrome','ifuse','networkmanager-dmenu-git','qimgv-git','qnapi','pavolume-git','remmina','winbox']
...
software_productivity: ['barrier','calc','dbeaver','nemo-fileroller','rsync','scrcpy','task','texlive-most']
